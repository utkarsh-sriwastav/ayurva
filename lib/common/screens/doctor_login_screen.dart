...
/// Doctor login — collects full name + phone number, then triggers
  ...
  Future<void> _handleSendOtp() async {
    ...
    final result = await FirebaseAuthService.instance.sendOtp(
      ...
      onAutoVerified: (userCredential) {
        ...
        // user typed anything — skip straight to Doctor Home.
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  ...
                  '(Real staff/ABDM-linked login will replace this later.)',
